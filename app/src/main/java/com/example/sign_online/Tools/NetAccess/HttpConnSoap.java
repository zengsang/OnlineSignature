package com.example.sign_online.Tools.NetAccess;
...
public class  HttpConnSoap {
    ...
    public static <T> InputStream  GetInputstream(String methodName, ArrayList<String> Parameters, ArrayList<T> ParValues) {
        ...
        String ServerUrl ="http://192.168.129.1:8888/";
		...
		*/
        ...
        try {
            ...
            System.out.println("过了输入流");
            //data=parser(inStream);
            //System.out.print("11");
            //	Values = inputStreamtovaluelist(inStream, methodName);
            //System.out.println(Values.size());
		/*	return Values;*/
            return inStream;                      //返回输入流

        } catch (Exception e) {
            System.out.print("2221"+e);
            return null;
        }
    }
    public ArrayList<String>  GetWebServre(InputStream inStream,String methodName){
        try {
            return inputStreamtovaluelist(inStream, methodName);
        } catch (IOException e) {
