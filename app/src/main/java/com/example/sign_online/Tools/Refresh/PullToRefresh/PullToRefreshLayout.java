package com.example.sign_online.Tools.Refresh.PullToRefresh;
...
import com.example.sign_online.Tools.Refresh.RefreshView.Pullable;
...
public class PullToRefreshLayout extends RelativeLayout
{
	...
	/**
	 * @param refreshResult
	 * @param myGridview 要刷新的gridview
	 * @param listView 要刷新的recycleview
	 * @param adapter 适配器
	 *            PullToRefreshLayout.SUCCEED代表成功，PullToRefreshLayout.FAIL代表失败
	 */
	public <T> void refreshFinish(int refreshResult,int id,MyGridview myGridview,ListView listView,T adapter)
	{
		...
		case SUCCEED:
			...
			if(myGridview!=null){
				myGridview= (MyGridview) findViewById(id);
			    myGridview.setAdapter((BaseAdapter) adapter);
			}
			else if(listView!=null){
				listView= (ListView) findViewById(id);
				listView.setAdapter((MyProtocelListViewAdapter)adapter);
			}
