 ...
 */
public class SSelectUserIconThread extends MyBaseSelectThread{
    ...
    public SSelectUserIconThread(Context context, MyBaseHandler mybasehandler,int msgwhat, ArrayList<String> list_real_param){
        super(context,mybasehandler,msgwhat,list_form_param,list_real_param,"Getusericon");
    }
