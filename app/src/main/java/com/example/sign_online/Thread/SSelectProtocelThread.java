 ...
 */
public class SSelectProtocelThread extends MyBaseSelectThread{
    ...
    public SSelectProtocelThread(Context context, MyBaseHandler mybasehandler, int msgwhat, ArrayList<String> list_real_param){
        super(context,mybasehandler,msgwhat,list_form_param,list_real_param,"Getprotocel");
    }
