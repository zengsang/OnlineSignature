 ...
 */
public class SInsertUserImportantMsgThread extends MyBaseNormalThread {
    ...
    static {
        ...
        list_form_param.add("userpassword");
    }
    public SInsertUserImportantMsgThread(Context context, MyBaseHandler mybasehandler, int msgwhat, ArrayList<String> list_real_param){
        super(context,mybasehandler,msgwhat,list_form_param,list_real_param,"Sinsertimportusermsg");
    }
