...
/**
 * Created by 曾志强 on 2016/2/11.
 */
public class SUploadUserprotocelMouldToServerThread extends MyBaseNormalThread{
    ...
    static {
        ...
        list_form_param.add("protocelmouldcontent");
    }
    public SUploadUserprotocelMouldToServerThread(Context context, MyBaseHandler mybasehandler, int msgwhat, ArrayList<String> list_real_param){
        super(context,mybasehandler,msgwhat,list_form_param,list_real_param,"Saveprotocelmould");
    }
