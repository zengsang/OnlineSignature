 ...
 */
public class SInsertNewuserNormalThread extends MyBaseNormalThread {
    ...
    static {
        ...
        public SInsertNewuserNormalThread(Context context, MyBaseHandler mybasehandler, int msgwhat, ArrayList<String> list_real_param){
