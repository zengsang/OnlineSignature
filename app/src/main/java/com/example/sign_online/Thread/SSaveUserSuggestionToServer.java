...
/**
 * Created by 曾志强 on 2016/3/2.
 */
public class SSaveUserSuggestionToServer extends MyBaseNormalThread{
    ...
    static {
        ...
        list_form_param.add("usersuggestion");
    }
    public SSaveUserSuggestionToServer(Context context, MyBaseHandler mybasehandler, int msgwhat, ArrayList<String> list_real_param){
        super(context,mybasehandler,msgwhat,list_form_param,list_real_param,"Saveusersuggestion");
    }
}
