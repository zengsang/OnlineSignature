 ...
 */
public class SGettranslatemsgfromServer extends MyBaseSelectThread{
    ...
    static{
        list_form_param.add("recevieport");
    }
    public SGettranslatemsgfromServer(Context context, MyBaseHandler mybasehandler, int msgwhat, ArrayList<String> list_real_param){
        super(context,mybasehandler,msgwhat,list_form_param,list_real_param,"Gettranslatemsgbyreceiver");
    }
    @Override
    public void run() {
        super.run();
